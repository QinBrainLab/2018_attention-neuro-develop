...
data.grp    <- "cohort1"                        # Group of the data
data.subgrp <- c("CBDC", "CBDA")                # Subgroups of the data
CBDC <- read.csv("fig1_data_cohort1_child.csv") # Read result file of basic information (.csv) for subgroup 1
CBDA <- read.csv("fig1_data_cohort1_adult.csv") # Read result file of basic information (.csv) for subgroup 2
